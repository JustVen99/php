<main>
    <div class="container-fluid p-3">
        <h3>Danh sách đang vận chuyển</h3>
        <div class="tools">
            <?php isset($MESSAGE) ? $MESSAGE : $MESSAGE = ""; ?>
            <span class="text-danger"><?= $MESSAGE ?></span>
            <div class="d-flex ms-auto gap-3">
                <a href="index.php?btn_wait">Chờ xác nhận</a>
                <a href="index.php?btn_trans" class="active">Đang vận chuyển</a>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td><a href="index.php?btn_edit&ma_don_hang=<?= $ma_don_hang ?>"><i class="fa-solid fa-pen-to-square" style="color: #ee5858;"></i></a></td>
